...
- [Step 1: Create the Argo CD Machine User Account](#step-1-create-the-machine-user-account)
- [Step 2: Add Argo CD Machine User to Organization](#step-2-add-machine-user-to-organization)
